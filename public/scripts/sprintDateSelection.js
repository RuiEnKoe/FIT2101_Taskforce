...
function saveData(){
  ...
  const firestoreStartDate = firebase.firestore.Timestamp.fromDate(startDate);
  const firestoreEndDate = firebase.firestore.Timestamp.fromDate(endDate);
...
if (startDate > endDate) {
  ...
  let data = {
    ...
    status: 'Not Started',
    parentid: 'sprints'  // Here's the addition
  };
  // Error checking
